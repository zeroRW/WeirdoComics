    ...
    <div class="card card-body">
        ...
        <form action="actualizarProv" method="POST">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="País de empresa" name="txtPais" value="{{old('txtPais')}}">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" placeholder="Contacto de empresa" name="txtContacto" value="{{old('txtContacto')}}">
                    <p class="text-danger">{{$errors->first('txtContacto')}}</p>
                </div>
                <label class="col-sm-2 col-form-label">No. Fijo:</label>
                <div class="col-sm-4">
                    <input type="text" class="form-control" placeholder="Numero de empresa" name="txtNumero" value="{{old('txtNumero')}}">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" placeholder="Celular de proveedor" name="txtCelular" value="{{old('txtCelular')}}">
                    <p class="text-danger">{{$errors->first('txtCelular')}}</p>
                </div>
                <label class="col-sm-2 col-form-label">Correo:</label>
                <div class="col-sm-4">
                    <input type="text" class="form-control" placeholder="Correo de empresa" name="txtCorreo" value="{{old('txtCorreo')}}">
