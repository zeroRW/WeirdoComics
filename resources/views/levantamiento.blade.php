                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr class="">               
                            ...
                            <td class="text-center"><a href="{{route('pedidoCo.pdf',[$data->idPedidoC,$data->idComics])}}"><button>PDF</button></a><a href="{{route('correo.env')}}"><button>Enviar a correo</button></a></td>
                        </tr>
                         @endforeach
                    </tbody>
                </table>
